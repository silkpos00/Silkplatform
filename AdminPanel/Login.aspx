<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AdminPanel.Login" Async="true" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <a href="index.html" class="app-brand auth-cover-brand gap-2">
        ...
        <span class="app-brand-text demo text-heading fw-bold">SILK POS</span>
      </a>
      <!-- /Logo -->
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto mt-sm-12 mt-8">
            <h4 class="mb-1">Welcome to Silk Pos</h4>
        ...
        <asp:TextBox ID="txtUsername"  CssClass="form-control"  runat="server" name="email-username"  type="text"    placeholder="Enter your email or username"   autofocus></asp:TextBox>
              </div>
              ...
              <div class="my-7">
                ...
                <asp:Button ID="btnSignIn" Text="Sign in" runat="server" class="btn btn-primary d-grid w-100" OnClick="btnSignIn_Click"/>
               
                <div class="m-3 text-danger text-center">
